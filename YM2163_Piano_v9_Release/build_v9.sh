#!/bin/bash
# Build script for YM2163 Piano GUI v9 with MIDI Player

echo "Building YM2163 Piano GUI v9 (MIDI Player Edition)..."
...
# Output
TARGET=ym2163_piano_gui_v9.exe
...
$CC $CFLAGS -c ym2163_piano_gui_v9.cpp -o ym2163_piano_gui_v9.o || exit 1

echo "============================================"
echo "Step 4: Linking..."
echo "============================================"

$CC -o $TARGET ym2163_piano_gui_v9.o \
